...
export function PasswordResetEmail({ code, expires }: { code: string; expires: Date }) {
  return (
    <Html>
      <Tailwind>
        <Head />
        <Container className="container px-20 font-sans">
          ...
          <Text className="text-sm">Please enter the following code on the password reset page.</Text>
