    ...
    <form
      ...
      onSubmit={(event) => {
        ...
        signIn(provider ?? "password", formData)
          ...
          .catch((error) => {
            console.error(error);
            const title = flow === "signIn" ? "Could not sign in, did you mean to sign up?" : "Could not sign up, did you mean to sign in?";
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {handlePasswordReset && flow === "signIn" ? (
          <Button className="p-0 h-auto" type="button" variant="link" onClick={handlePasswordReset}>
